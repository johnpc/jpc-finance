    ...
    Header() {
      ...
      return (
        <View textAlign="center" backgroundColor={"#7FFFD4"} padding={"15px"}>
          <Image alt="logo" borderRadius={tokens.radii.xl} width={"100px"} src="/maskable.png" />
    ...
    Footer: () => (
      <div style={{ textAlign: "center" }}>
        {Capacitor.getPlatform() === "ios" ? null : (
          <Link href="https://apps.apple.com/us/app/jpc-finance/id6499078837" style={{ color: "white" }}>
